  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        assignee: { type: "string", enum: ["Claude", ...SUBAGENTS.map((s) => s.name)], description: "\"Claude\" = the dev, who scopes/collaborates on builds first; otherwise the subagent name." },
